  ...
  return (
    <Row>
      {jobs.map(job  => (
        ...
        <Nav.Link as={Link} to={`/game-view/${job._id}`}><Card.Title>{job.gametitle}</Card.Title></Nav.Link>
        <Card.Body>
          ...
          <img  src={`http://localhost:8000/uploads/${job.imgpath || "https://usr.dokan-cdn.com/img/avatars/default.jpg"}`} alt="" /><a href="https://usr.gg/meshari">@Ijas Ahamed</a></div></span>
          </Card.Text>
          </Card.Body>
            <ListGroup.Item>
