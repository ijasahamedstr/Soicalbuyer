    ...
    <Row>
          {jobs.length === 0 ? (
            <p style={{fontSize:'20px'}}>لم يتم العثور على حساب..</p>
                ...
                <Nav.Link href='/game-view'><Card.Title>حساب ببجي لفل 76 نوادر واسلحه مط</Card.Title></Nav.Link>
                <Card.Body>
                  <Card.Text style={{fontSize:'13px'}}>
                    حساب فورت يحتوي على ايكونيك و طور الزومبي ورويال بومبر نص سيزون 2 + سيزون 3 كامل
                    يحتوي 81 سكن ....</Card.Text>
                  <Card.Text>
