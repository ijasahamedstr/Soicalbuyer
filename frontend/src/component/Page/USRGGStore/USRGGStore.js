...
import './USRGGStore.css';

function Store({ isActive = false }) {
  const gridContainerStyle = {
    ...
    return (
      ...
      <div className="row justify-content-center mt-4" style={{textAlign:'center',fontFamily:'Noto Kufi Arabic',marginBottom:'30px'}}>
      <h5 style={{marginTop:'30px'}}>مبيعات الخدمات</h5>
      </div>
      <Row>
      <Col sm={4}>
      {isActive ? 
        <div className="p-3">
              <div className='feature'>
              <Card style={{border:'none',backgroundColor: `rgba(var(--bs-info-rgb), 0.1)`,height:'115px'}}>
                <Card.Body>
                <div className="c-card u-bg--light-gradient u-text--dark">
                  <div className="c-card__body">
                  <div className="u-display--flex u-justify--space-between">
