...
function SoiaclAcoountView({isLoggedIn = true }) {
  ...
  return (
    ...
    <Row>
        ...
        <div class="col-12">
        <div class="sign">
        <div class="sign__content" style={{background:'#222227',borderRadius:'30px'}}>
        <Card.Img variant="top" src="https://usr.dokan-cdn.com/instagram.png" style={{borderRadius:'30px',width:'50%'}}  />
        </div>
        </div>
        </div>
        </div>
        ...
        <Col sm={5}>
        <Card style={{background:'#F8F9F9',marginBottom:'30px',border:'none'}}>
        <Card.Body>
        <Card.Title style={{fontFamily:'Noto Kufi Arabic',fontSize:'25px'}}>وصف الحساب</Card.Title>
        <Card.Subtitle className="mb-2 text-muted" style={{marginTop:'30px',fontSize:'15px',fontFamily:'Noto Kufi Arabic'}}>يوزر فخم وانشاء 2013 معنى اساسي ماداخل رقم</Card.Subtitle>
        <Card.Text style={{marginTop:'30px',color:'red'}}>
        إبلاغ
        </Card.Text>
        <ul className="asset__authors">
        <li>
        <span style={{fontFamily:'Noto Kufi Arabic'}}>البائع</span>
        ...
        <li>
        <span style={{fontFamily:'Noto Kufi Arabic'}}>المنصة</span>
        <div class="asset__author ">
        <img src="https://usr.gg/img/social/instagram.png" alt=""/>
        <div>instagram</div>
        </div>
        </li>
        </ul>
        ...
        justify
        >
        <Tab eventKey="تفاصيل التسليم" title="تفاصيل التسليم" style={{marginBottom:'20px',marginTop:'20px',fontFamily:'Noto Kufi Arabic'}}>
        <span>تسليم تلقائي؟</span>
        <p style={{color:'#0081e3'}}>نعم</p>
        <span>مع الأيميل الأساسي؟</span>
        <p style={{color:'#00e300'}}>نعم</p>
        <span>مع الأيميل الحالي؟</span>
        <p style={{color:'#e3cc00'}}>لا</p>
        <span style={{color:'red'}}>مربوط برقم؟</span>
        <p style={{color:'#00ff04'}}>لا</p>
        <span style={{color:'red'}}>صاحب المنتج موثق بهوية؟</span>
        <p style={{color:'#00ff04'}}>نعم</p>
        </Tab>
        <Tab eventKey="أخرى" title="أخرى" style={{marginBottom:'20px',marginTop:'20px',fontFamily:'Noto Kufi Arabic'}}>
        <span>عدد المُتابعين (Followers)</span>
        <p style={{color:'#9152ff'}}>3</p>
        <span>عدد المتابعات (Following)</span>
        <p style={{color:'#6722dd'}}>1</p>
        </Tab>
        </Tabs>
        {isLoggedIn ? 
         <button  onClick={() => setModalShowone(true)}  class="asset__btn asset__btn--clr open-modal"><span id="PriceQuotation"> ($120.00) </span> شراء </button>
        :  <button  onClick={() => setModalShow(true)} class="asset__btn asset__btn--clr open-modal"><span id="PriceQuotation"> ($120.00) </span> شراء </button>  }
